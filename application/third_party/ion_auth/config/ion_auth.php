 ...
 */
$config['site_title']                 = "IPPL";       // Site Title, example.com
$config['admin_email']                = 'tvri@gmail.com'; // Admin Email, admin@example.com
$config['default_group']              = 'vendor';           // Default group, use name

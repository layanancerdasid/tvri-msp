...
<head>
    ...
    <meta name="description" content="Merupakan aplikasi pendukung yang wajib dimiliki oleh penerima bantuan program Layanan Headend TVRI dari Direktorat Infrastruktur Pita Lebar Kementerian Komunikasi dan Informatika untuk melaporkan mulainya dan permasalahan alat-alat yang di BASTkan.">
		...
		<form>
			...
			<div class="col-sm-12">
					<div class="col-sm-6 pull-left"  style="background: rgba(255,255,255,0.8);padding:10px;max-height:450px;">
							<h5 class="text-sm-center mt-2 mb-1">Headend Mobile Apps</h5>
							<br>
							<p align='justify'>Merupakan aplikasi pendukung yang wajib dimiliki oleh penerima bantuan program Layanan Headend TVRI dari Direktorat Infrastruktur Pita Lebar Kementerian Komunikasi dan Informatika untuk melaporkan mulainya dan permasalahan alat-alat yang di BASTkan..</p>
							<hr>
							...
							<br> <a href="<?php echo base_url()?>headend/headend_install" style="font-weight:normal;"><i class="fa fa-suitcase pr-1"></i>&nbsp;Cara Instalasi Aplikasi Headend Mobile Apps</a>
							<br> <a href="<?php echo base_url()?>headend/headend_lapor_app" style="font-weight:normal;"><i class="fa fa-ticket pr-1"></i>&nbsp;Cara Lapor Harian Kondisis Alat (Via Mobile Apps)</a>
							<br> <a href="<?php echo base_url()?>headend/headend_lapor_web" style="font-weight:normal;"><i class="fa fa-ticket pr-1"></i>&nbsp;Cara Lapor Harian Kondisis Alat (Via Web)</a>
							</p>
							<br><br><br><br>
					...
					<div class="col-sm-6 pull-right"   style="background: rgba(255,255,255,0.8);padding:10px;max-height:450px;">
						...
						<h6 class="text-sm-center mt-2 mb-1" style="text-align:center;"><a href="www.android.com"><i class="fa fa-android">&nbsp;Android</i></a></h6>
							...
							<div class="mx-auto d-block">
									<img class="mx-auto d-block" src='.././assets/img/headend/qr_headend_ippl.png' alt="Card image cap" style="width:80%">
							</div>
								<div class="location text-sm-center" style="text-align:center"> 
									<p class="text-center small">
										<h6><a href="<?php echo $link; ?>"><font color="blue">Click here</font></a> for alternatif link to download apps.</h6>
									</p>
								</div>
						</div>
					</div>

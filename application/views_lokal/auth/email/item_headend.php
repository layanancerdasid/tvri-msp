...
<body>
	...
	<table 	width="600" style="text-align:left;" border="0">
		...
		<tr>
			...
			<td>
				<h3 style="margin: 0px; width:466px;" ><b>Laporan Kendala Item Headend</b></h3>
			...
			<td colspan="3">
				<table cellpadding="0" cellspacing="0" border="0" width="600">
					...
					<tr>
						<td></td>
						<td colspan="4">
							<p>Kami telah menerima laporan <b>kendala item</b>, tanggal <b> <?php echo $tgl_laporan;?> </b> dari pengguna Program Penerima Bantuan Internet Kabel Gratis Fixed Broadband (FBB) Direktorat Pengembangan Pitalebar. Berikut informasi lengkapnya: </p>
						</td>
					</tr>
					<tr>
						<?php echo $m_body;?>

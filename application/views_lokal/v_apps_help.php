...
<div class="login-form">	
		<form>
			...
			<div class="col-sm-12">
					<div class="col-sm-12 pull-left"  style="background: rgba(255,255,255,0.8);padding:10px;min-height:450px;">
							
							<br>
							<div class="card-header user-header alt bg-dark">
									<div class="media">
											<a href="#">
													<img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src='.././assets/img/petunjuk.png'>
											</a>
											<div class="media-body">
													<h2 class="text-light display-6">PUSAT BANTUAN </h2>
											</div>
									</div>
							</div>
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item">
										<a href="<?php echo base_url()?>apps/fbbkonten/1" style="font-weight:normal;"><i class="fa fa-suitcase pr-1"></i>&nbsp;Cara Instalasi Aplikasi FBB Mobile Apps</a>
								</li>
								<li class="list-group-item">
										<a href="<?php echo base_url()?>apps/fbbkonten/2" style="font-weight:normal;"><i class="fa fa-ticket pr-1"></i>&nbsp;Cara Lapor Mulainya Layanan Akses Internet</a>
								</li>
								<li class="list-group-item">
										<a href="<?php echo base_url()?>apps/fbbkonten/3" style="font-weight:normal;"><i class="fa fa-thumbs-down pr-1"></i>&nbsp;Cara Lapor Gangguan/Mati Akses Internet</a>
								</li>
								<li class="list-group-item">
										<a href="<?php echo base_url()?>apps/fbbkonten/4" style="font-weight:normal;"><i class="fa fa-thumbs-up pr-1"></i>&nbsp;Cara Lapor Internet Sudah Nyala Kembali Setelah Gangguan</a>
								</li>
								<li class="list-group-item">
										<a href="<?php echo base_url()?>apps/fbbkonten/4" style="font-weight:normal;">&nbsp;</a>
								</li>
								<li class="list-group-item">
										<a href="<?php echo base_url()?>apps/contactus" style="font-weight:normal;"><i class="fa fa-question"></i>&nbsp;Hubungi Kami</a>
								</li>

							...
							<ul class="menu-nav">
								<li class="menu-item" aria-haspopup="true">
									<a href="index.html" class="menu-link">
										...
										<span class="menu-text">Manual Book</span>
									</a>
								</li>
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="javascript:;" onclick="logout_();return false;" class="menu-link">
												...
												<ul class="menu-subnav">
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														...
														<div class="menu-submenu menu-submenu-classic menu-submenu-right">
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>pengadaan/kontrak/lelang" class="menu-link">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>pengadaan/kontrak/nonlelang" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
															...
															<ul class="menu-subnav">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>metering/qc_metering" class="menu-link">
																		...
																		<span class="menu-text">Question Content Metering</span>
																	</a>
																</li>
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>metering/report" class="menu-link">
																		...
																		<span class="menu-text">Reporting Metering</span>
																	</a>
																</li>
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>metering/apps" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Apps Metering</span>
																	</a>
																</li>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														<a href="javascript:;" class="menu-link menu-toggle">
															...
															<span class="menu-text">Transmisi</span>
															<i class="menu-arrow"></i>
														</a>
														<div class="menu-submenu menu-submenu-classic menu-submenu-right">
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>transmisi" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>transmisi/dsh_digital" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Dashboard Digital</span>
																	</a>
																</li>
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>transmisi/dsh_analog" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Dashboard Analog</span>
																	</a>
																</li>
															</ul>
														</div>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="javascript:;" class="menu-link">
															...
															<span class="menu-text">TOR/KAK</span>
														</a>
													</li>
												...
												<ul class="menu-subnav">
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														<a href="javascript:;" class="menu-link menu-toggle">
															...
															<span class="menu-text">A-M</span>
															<i class="menu-arrow"></i>
														</a>
														<div class="menu-submenu menu-submenu-classic menu-submenu-right">
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>master/fec" class="menu-link">
																		<span class="svg-icon menu-icon">
																			<i class="menu-icon fas fa-money-bill-alt"></i>
																		</span>
																		<span class="menu-text">FEC</span>
																	</a>
																</li>
																<li class="menu-item" aria-haspopup="true">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>master/grpetugas" class="menu-link">
																		<span class="svg-icon menu-icon">
																			<i class="menu-icon fas fa-money-bill-alt"></i>
																		</span>
																		<span class="menu-text">Grup Petugas</span>
																	</a>
																</li>
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>master/guard" class="menu-link">
																		<span class="svg-icon menu-icon">
																			<i class="menu-icon fas fa-money-bill-alt"></i>
																		</span>
																		<span class="menu-text">Guard Interval</span>
																	</a>
																</li>
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>master/kategori" class="menu-link">
																		<span class="svg-icon menu-icon">
																			<i class="menu-icon fas fa-money-bill-alt"></i>
																		</span>
																		<span class="menu-text">Kategori Pekerjaan</span>
																	</a>
																</li>
																<li class="menu-item" aria-haspopup="true">
															...
															<span class="menu-text">Tool Cari Alamat</span>
														</a>
													</li>
																<li class="menu-item" aria-haspopup="true">
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														...
														<div class="menu-submenu menu-submenu-classic menu-submenu-right">
															<ul class="menu-subnav">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>master/project" class="menu-link">
																		<span class="svg-icon menu-icon">
																			<i class="menu-icon fas fa-money-bill-alt"></i>
																		</span>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>master/direktorat" class="menu-link">
																		<span class="svg-icon menu-icon">
																			<i class="menu-icon fas fa-money-bill-alt"></i>
																		</span>

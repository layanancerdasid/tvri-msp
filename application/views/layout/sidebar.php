							...
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
								...
								<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
									...
									<ul class="menu-nav">
										...
										<li class="menu-item menu-item-here menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
											<a href="javascript:;" class="menu-link menu-toggle">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-left">
												<ul class="menu-subnav">
													...
													<li class="menu-item" aria-haspopup="true">
																	<a href="<?=base_url()?>master/merk" class="menu-link">
															<span class="svg-icon menu-icon">
																<i class="menu-icon fas fa-money-bill-alt"></i>
															</span>
															<span class="menu-text">Merk Pemancar</span>
														</a>
													</li>
													<li class="menu-item" aria-haspopup="true">
									...
									<a href="#" onclick="logout_();return false;" class="menu-link">
										<i class="icon-xl fas fa-power-off"> </i>
										<span class="menu-text">&nbsp Logout</span>
									</a>
									</ul>
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?= $this->session->userdata('identity');?></span>

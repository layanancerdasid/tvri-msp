...
<html class="no-js" lang=""> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		 <title>e-Transmisi TVRI::<?php echo $title;?></title>
		...
		<link href="<?=base_url();?>assets/home/css/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" class="w-45px" src="<?=base_url();?>assets/img/metroconic/logo-tvri-white_w198_h138.png"/>
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->

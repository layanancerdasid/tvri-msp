...
<head>
	...
	<title>Direktorat Pengembangan Pitalebar - Tiket Laporan Bantuan TIK</title>
	...
	<table 	width="600" style="text-align:left;" border="0">
		...
		<tr>
			...
			<td style="text-align:center;" style="max-width:80px;">
				<img src="http://ippl.ptmsp.id/images/navs/kominfo_basic.png" style="max-width:80px;" alt=""/></td>
			</td>
			<td>
			...
			<td colspan="3">
				<table cellpadding="0" cellspacing="0" border="0" width="600">
					...
					<tr>
						<td></td>
						<td colspan="4">
							<p>Kami telah menerima pesan <b><?php echo $m_warning;?></b> dari pengguna Program Penerima Bantuan Teknologi Informasi dan Komunikasi Direktorat Pengembangan Pitalebar. <br>Berikut informasi lengkapnya: </p>
						</td>
					</tr>
					<tr>
						<td colspan="5"><?php echo $m_body;?></td>
					</tr>
					<tr>
						<td></td>
						<td colspan="4">

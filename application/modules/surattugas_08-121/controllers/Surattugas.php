	...
	public function index() 
	{
		...
		$g->select_command = "SELECT *
								FROM (
									...
									, nama_lokasi, tanggal, st.idpegawai, tembusan, docs
		...
		$col["editrules"] = array("required"=>true); 
		$col["editoptions"] = array("rows"=>2, "maxlength"=>255, "cols"=>80, "placeholder"=>"berisikan isi surat......"); 
		...
		$col["edittype"] = "select"; 
		$str = $g->get_dropdown_values("SELECT DISTINCT pg.idpeg AS k, CONCAT(pg.nama_lengkap,' (',pg.nip,')') AS v 
																		FROM ms_pegawai pg where aktif='1'
																		ORDER BY 2");
		...
		$col["edittype"] = "textarea";
		$col["editrules"] = array("required"=>true); 
		$col["editoptions"] = array("rows"=>2, "maxlength"=>255, "cols"=>90, "placeholder"=>"berisikan tujuan atau nama kegiatan......(Max 255 karakter)"); 
		$col["show"] = array("list"=>false, "add"=>true, "edit"=>true, "view"=>true); 
		$cols[] = $col;
...
/*
		...
		*/
		...
		$col["name"] = "docs";
		$col["search"] = false;
		$col["isnul"] = true;$col["editable"] = true;
		$col["align"] = "left";
		$col["edittype"] = "file"; 
		$col["upload_dir"] = "files";
		$col["editrules"] = array("required"=>false, "ifexist"=>"error"); 
		$col["show"] = array("list"=>false,"edit"=>true,"add"=>false,"view"=>false);
		$cols[] = $col;
		...
		$col["show"] = array("list"=>true,"edit"=>true,"add"=>false,"view"=>true);
		$cols[] = $col;

						...
						<div class="card-header border-0 pt-5">
							<div class="card-title">
								<div class="card-label">
									<div class="font-weight-bolder">Dashboard Sebaran LPP TVRI</div>
								</div>
							</div>
						</div>
						<!--end::Header-->
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-3 my-2 my-md-0">
									...
									<select name="country" id="lahan" class="form-control">
										<option value="">All</option>
										<?= $optionlahan; ?>
									</select <!--end::Input-->
								</div>
		...
		google.maps.event.addListener(marker, 'click', (function(marker, v) {
			return function() {
				var labwin = '<div id="iw-container">' +
					...
					'<tr><td valign="top" width="100px">Lahan</td><td valign="top">&nbsp;:&nbsp;</td><td valign="top"> ' + item.status_lahan + '</td></tr>' +
					'<tr><td valign="top">Alamat</td><td valign="top">&nbsp;:&nbsp;</td><td valign="top"> ' + item.alamat + '</td></tr>' +
					'<tr><td valign="top">Coverage Populasi</td><td valign="top">&nbsp;:&nbsp;</td><td valign="top"> ' + item.populasi + '</td></tr>' +
					'<tr><td valign="top">Koordinat</td><td valign="top">&nbsp;:&nbsp;</td><td valign="top"> ' + item.lat + ' ,' + item.long + '</td></tr>' +
					'<tr><td valign="top">Channel</td><td valign="top">&nbsp;:&nbsp;</td><td valign="top"> ' + item.channel + '</td></tr>' +
					'<tr><td valign="top">Tower</td><td valign="top">&nbsp;:&nbsp;</td><td valign="top"> ' + item.tower + '</td></tr>' +
					'</table>' +
					'</div>' +

...
class Transmisi extends CI_Controller {
	...
	public function pemancar($idparams)
	{
		...
		$col["editoptions"] = array("value"=>"Analog:Analog;Digital:Digital;Dualcast:Dualcast;VHF:VHF;Unknown/STL:Unknown/STL");
		$cols[] = $col;
	...
	public function export($idlokasi)
	{
		...
		// sheet detailpemancar
		{
			...
			$arrtipe = ["Analog", "Digital","Dualcast","VHF", "Unknown/STL"];

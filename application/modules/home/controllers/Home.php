...
class Home extends CI_Controller {
	...
	public function load_lokasi(){
		...
		if($rsl)
			...
			$total += count($arrloc);
		$datas = array("total"=>$total, "sumAnalog"=>$sumAnalog, "sumDigital"=>$sumDigital, "sumDualcast"=>$sumDualcast, "sumVhf"=>$sumVhf, "sumUnknown"=>$sumUnknown, "totlLokasi"=>$totlLokasi, "titleAnalog"=>$titleAnalog, "titleDigital"=>$titleDigital, "titleDualcast"=>$titleDualcast, "titleVhf"=>$titleVhf, "titleUnknown"=>$titleUnknown, "titleLokasi"=>$titleLokasi, "datas"=>$arrloc);
